...
public class NotificationListConverter extends Converter<NotificationListObject> {
  ...
  public static Notification convert(final NotificationPB notification) {
    ...
    return Notification.builder().withId(notification.getId())
        .withCategory(notification.getCategory()).withMessage(notification.getMessage())
  ...
  public static NotificationPB convert(final Notification notification) {
    final NotificationPB.Builder builder =
        NotificationPB.newBuilder().setId(notification.getId().get())
            .setCategory(notification.getCategory()).setMessage(notification.getMessage())
            .setCreatedAt(notification.getCreatedAt().getMillis());

    for (Map.Entry<String, String> property : notification.getProperties().entrySet()) {
