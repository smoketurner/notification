...
public class NotificationStore {
  ...
  public NotificationStore(@Nonnull final MetricRegistry registry,
      ...
      @Nonnull final CursorStore cursors, @Nonnull final Map<String, Rule> rules) {
   ...
   */
  public Iterable<Notification> setUnseenState(@Nonnull final Iterable<Notification> notifications,
      final boolean unseen) {
    Preconditions.checkNotNull(notifications);
    return Iterables.transform(notifications, new Function<Notification, Notification>() {
      @Override
   ...
   */
  public Optional<Notification> tryFind(@Nonnull final Iterable<Notification> notifications,
      final long id) {
    Preconditions.checkNotNull(notifications);
   ...
   */
  public int indexOf(@Nonnull final Iterable<Notification> notifications, final long id) {
    Preconditions.checkNotNull(notifications);
   ...
   */
  public Iterable<Notification> skip(@Nonnull final Iterable<Notification> notifications,
