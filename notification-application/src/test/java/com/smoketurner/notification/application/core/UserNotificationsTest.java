...
public class UserNotificationsTest {
  ...
  public void testUnseen() {
    final List<Notification> unseen = ImmutableList.of(Notification.builder().withId(1L).build());
  ...
  public void testSeenUnseen() {
    final List<Notification> unseen = ImmutableList.of(Notification.builder().withId(1L).build());
    final List<Notification> seen = ImmutableList.of(Notification.builder().withId(2L).build());
    final List<Notification> expected =
        ImmutableList.of(Notification.builder().withId(2L).build(),
