...
public class NotificationListResolverTest {
  ...
  public void testMultipleSibling() throws Exception {
    ...
    final List<NotificationListObject> siblings = ImmutableList.of(list1, list2, list3);
  ...
  public void testRemoveNotifications() throws Exception {
    final List<Notification> notifications =
        ImmutableList.of(createNotification(1L), createNotification(2L), createNotification(3L),
            Notification.builder().build());

    final List<Notification> expected =
        ImmutableList.of(createNotification(2L), createNotification(3L));

    final List<Notification> actual =
        NotificationListResolver.removeNotifications(notifications, ImmutableList.of(1L));
  ...
  public void testRemoveNotificationsEmpty() throws Exception {
    ...
    final List<Notification> actual =
        NotificationListResolver.removeNotifications(notifications, ImmutableList.<Long>of());
    assertThat(actual).containsExactlyElementsOf(expected);
  }
