...
public class NotificationsIT {
  ...
  public static final DropwizardAppRule<NotificationConfiguration> RULE =
      new DropwizardAppRule<NotificationConfiguration>(
          NotificationApplication.class, ResourceHelpers.resourceFilePath("notification-test.yml"));
  ...
  public void testPagination() throws Exception {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      expected.add(Notification.builder(response).withUnseen(true).build());
    }
  ...
  private static Notification createNotification() {
    return Notification.builder("test-category", "this is only a test").build();
  }
}
