...
public class RuleResourceTest {
  ...
  public static final ResourceTestRule resources =
      ResourceTestRule.builder()
          ...
          .addProvider(new NotificationExceptionMapper())
          .build();
  ...
  public void testFetch() throws Exception {
    final Map<String, Rule> expected =
        ImmutableMap.of("follow", Rule.builder().withMaxSize(3).build());
    ...
    final Map<String, Rule> actual = response.readEntity(new GenericType<Map<String, Rule>>() {});
  ...
  public void testFetchJSONP() throws Exception {
    ...
    final Response response =
        resources.client().target("/v1/rules").request("application/javascript").get();
    ...
    assertThat(actual).isEqualTo("callback(" + MAPPER.writeValueAsString(expected) + ")");
  }
  ...
  public void testDeleteAll() throws Exception {
    final Response response =
        resources.client().target("/v1/rules").request(MediaType.APPLICATION_JSON).delete();
