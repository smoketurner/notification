...
public class RuleTest {
  ...
  public void serializesToJSON() throws Exception {
    ...
    final String expected =
        MAPPER.writeValueAsString(MAPPER.readValue(fixture("fixtures/rule.json"), Rule.class));
    assertThat(actual).isEqualTo(expected);
  }

  @Test
  public void deserializesFromJSON() throws Exception {
    final Rule actual = MAPPER.readValue(fixture("fixtures/rule.json"), Rule.class);
    assertThat(actual).isEqualTo(rule);
  }

  @Test(expected = JsonMappingException.class)
  public void testInvalidDuration() throws Exception {
    MAPPER.readValue(fixture("fixtures/rule_invalid_duration.json"), Rule.class);
  }

  @Test(expected = JsonMappingException.class)
  public void testInvalidTimeUnit() throws Exception {
    MAPPER.readValue(fixture("fixtures/rule_invalid_timeunit.json"), Rule.class);
  }

  @Test
  public void testInvalidMatchOn() throws Exception {
    final Rule actual = MAPPER.readValue(fixture("fixtures/rule_invalid_matchon.json"), Rule.class);
